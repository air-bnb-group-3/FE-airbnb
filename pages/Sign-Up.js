      ...
      <div className="bg-cover bg-image flex flex-col items-center max-w-screen-lg overflow-hidden rounded-lg shadow-lg text-gray-600 w-full md:flex-row">
        ...
        <div className="bg-white flex flex-col items-center p-4 space-y-8 w-full md:w-1/2">
          ...
          <div className="flex flex-col items-center">
            <h1 className="font-medium text-green-400 text-xl">Selamat Datang</h1>
            <p>Silahkan Daftar</p>
          </div>
          ...
          <form className="flex flex-col items-center space-y-4">
            <div className="relative">
              ...
              <input className="border border-gray-300 outline-none placeholder-gray-400 pl-9 pr-4 py-1 rounded-md transition focus:ring-2 focus:ring-green-300" placeholder="Nama Lengkap..." type="text"/>
            </div>
            <div className="relative">
              <span className="absolute flex inset-y-0 items-center pl-4 text-gray-400"><FiMail /></span>
              <input className="border border-gray-300 outline-none placeholder-gray-400 pl-9 pr-4 py-1 rounded-md transition focus:ring-2 focus:ring-green-300" placeholder="Email..." type="text"/>
            </div>
            <div className="relative">
              <span className="absolute flex inset-y-0 items-center pl-4 text-gray-400"><FaLock /></span>
              <input className="border border-gray-300 outline-none placeholder-gray-400 pl-9 pr-4 py-1 rounded-md transition focus:ring-2 focus:ring-green-300" placeholder="Kata Sandi..." type="text"/>
            </div>
          ...
          <div className="flex flex-col items-center">
            <p className="italic">
              ...
              <NextLink href="/Sign-In">
                <a className="ml-1 text-green-500 hover:underline">Masuk di sini</a></NextLink> 
            </p>
          </div>
        </div>
      </div>
