...
function AddMyHouse() {
  ...
  const [bed, setBed] = useState(['Single', 'Twin', 'Queen']);
  ...
  const handleBedChange = (e) => {
    console.log(setBed(bed[e.target.value]));
  };
  ...
  function handleAdd() {
    ...
    swal({
      ...
      if (willEdit) {
        axios
          .post('http://18.136.193.63:8081/rooms', formData, config)
          .then(({ data }) => {
            console.log(data);
          })
          .catch((err) => {
        ...
        swal('Success add new rent house', {
          icon: 'success',
        });
      } else {
    ...
    <>
      ...
      <div className="h-auto pt-20 bg-gray-100">
        <div className="container mx-auto ">
          <h1 class="text-center font-bold text-2xl">ADD NEW RENT HOUSE</h1>
        </div>
        <div className="max-w-6xl mx-5 pt-10 xl:mx-auto mb-10">
          <div className="grid grid-cols-4 gap-4 shadow-lg">
            ...
            <div className="flex justify-center flex-col mx-auto py-6 ml-10 mt-3">
              ...
              <div className="buttonAction flex justify-between mt-10">
                <Link href="/profile/myhouse">
